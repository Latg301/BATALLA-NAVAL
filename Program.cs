...
namespace Astucia_naval
{
    internal class Program
    {
...

        {
            ...
            Console.WriteLine("Ingrese la posición del nave Vertical=1 Horizontal=0");
            ...
            Console.WriteLine("Ingrese la longitud del nave (Debe ser menor o igual a 9)");
            ...
            Console.WriteLine("Ingrese donde se ubica el punto inicial del nave de forma x,y:");
            ...
            do
            {
                Console.WriteLine("¿En dónde cree que estará el nave? Ingrese las coordenadas de la forma x,y");
                ...
                if (shot == longitud)
                {
                    ...
                    Console.WriteLine("¡Te esperamos pronto para jugar!");
                }
